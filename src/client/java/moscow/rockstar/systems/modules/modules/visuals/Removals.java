...
public class Removals extends BaseModule {
    ...
    private final SelectSetting.Value waterBlur = new SelectSetting.Value(this.effects, "modules.settings.removals.waterBlur");
    private final SelectSetting.Value lavaFog = new SelectSetting.Value(this.effects, "modules.settings.removals.lavaFog").select();
    ...
    private final EventListener<ClientPlayerTickEvent> onUpdateEvent = event -> {
        // 1.21.6+: old fov effect option accessor changed; keep module stable without direct option mutation here.
        if (Removals.mc.player == null) {
            return;
        }
        if (this.blindness.isSelected()) {
            Removals.mc.player.removeEffect(MobEffects.BLINDNESS);
            Removals.mc.player.removeEffect(MobEffects.DARKNESS);
        }
    };

    @Override
    public void onEnable() {
        this.oldFovEffectScale = 1.0;
        super.onEnable();
    }
    ...
    @Generated public double getOldFovEffectScale() { return this.oldFovEffectScale; }
    @Generated public SelectSetting getEffects() { return this.effects; }
    @Generated public SelectSetting.Value getHurtCam() { return this.hurtCam; }
    @Generated public SelectSetting.Value getScoreboard() { return this.scoreboard; }
    @Generated public SelectSetting.Value getBossBar() { return this.bossBar; }
    @Generated public SelectSetting.Value getPortal() { return this.portal; }
    @Generated public SelectSetting.Value getFire() { return this.fire; }
    @Generated public SelectSetting.Value getClip() { return this.clip; }
    @Generated public SelectSetting.Value getBreakParticles() { return this.breakParticles; }
    @Generated public SelectSetting.Value getWater() { return this.water; }
    @Generated public SelectSetting.Value getWaterBlur() { return this.waterBlur; }
    @Generated public SelectSetting.Value getLavaFog() { return this.lavaFog; }
    @Generated public SelectSetting.Value getNausea() { return this.nausea; }
    @Generated public SelectSetting.Value getBlindness() { return this.blindness; }
    @Generated public SelectSetting.Value getPumpkin() { return this.pumpkin; }
    @Generated public SelectSetting.Value getFov() { return this.fov; }
    @Generated public SelectSetting.Value getWeather() { return this.weather; }
    @Generated public SelectSetting getSounds() { return this.sounds; }
    @Generated public SelectSetting.Value getBeacon() { return this.beacon; }
    @Generated public SelectSetting.Value getPhantoms() { return this.phantoms; }
    @Generated public SelectSetting.Value getWeatherSound() { return this.weatherSound; }
    @Generated public EventListener<ClientPlayerTickEvent> getOnUpdateEvent() { return this.onUpdateEvent; }
}
