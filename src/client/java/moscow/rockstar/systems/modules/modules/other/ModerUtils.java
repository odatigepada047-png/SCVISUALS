...
public class ModerUtils extends BaseModule {
    private final BindSetting lockTargetBind = new BindSetting(this, "Lock Target ESP");
    private final BindSetting openBind = new BindSetting(this, "Open Menu");

    // Target ESP Lock Feature (дополнение)
    private final moscow.rockstar.systems.setting.settings.BooleanSetting enableTargetLock =
            new moscow.rockstar.systems.setting.settings.BooleanSetting(this, "Enable Target Lock").enable();

    // Just Push binds
    private final BindSetting pushSlime = new BindSetting(this, "Push 2.2 (Слизь)", () -> !enableTargetLock.isEnabled());
    private final BindSetting pushMagma = new BindSetting(this, "Push 2.2.2 (Магма)", () -> !enableTargetLock.isEnabled());
    private final BindSetting pushPuffer = new BindSetting(this, "Push 2.2.3 (Иглобрюх)", () -> !enableTargetLock.isEnabled());
    private final BindSetting pushGhast = new BindSetting(this, "Push 2.8 (Слеза)", () -> !enableTargetLock.isEnabled());

    // SAC Push bind
    private final BindSetting sacPunish = new BindSetting(this, "SAC Punish", () -> !enableTargetLock.isEnabled());

    // Dupe IP bind
    private final BindSetting dupeIpBind = new BindSetting(this, "Dupe IP", () -> !enableTargetLock.isEnabled());
