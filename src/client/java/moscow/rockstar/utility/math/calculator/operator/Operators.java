 ...
 */
package moscow.rockstar.utility.math.calculator.operator;
...
public abstract class Operators {
    ...
    static {
        Operators.BUILT_IN_OPERATORS[0] = new Operator("+", 2, true, 500){
        ...
        Operators.BUILT_IN_OPERATORS[1] = new Operator("-", 2, true, 500){
        ...
        Operators.BUILT_IN_OPERATORS[6] = new Operator("-", 1, false, 5000){
        ...
        Operators.BUILT_IN_OPERATORS[7] = new Operator("+", 1, false, 5000){
        ...
        Operators.BUILT_IN_OPERATORS[2] = new Operator("*", 2, true, 1000){
        ...
        Operators.BUILT_IN_OPERATORS[3] = new Operator("/", 2, true, 1000){
        ...
        Operators.BUILT_IN_OPERATORS[4] = new Operator("^", 2, false, 10000){
        ...
        Operators.BUILT_IN_OPERATORS[5] = new Operator("%", 2, true, 1000){
