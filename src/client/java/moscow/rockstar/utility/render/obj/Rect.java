...
public class Rect {
    ...
    public static Rect interpolate(Rect oldValue, Rect newValue, double interpolationValue) {
        float interpolatedX = (float)((double)oldValue.x + (double)(newValue.x - oldValue.x) * interpolationValue);
        float interpolatedY = (float)((double)oldValue.y + (double)(newValue.y - oldValue.y) * interpolationValue);
        float interpolatedWidth = (float)((double)oldValue.width + (double)(newValue.width - oldValue.width) * interpolationValue);
        float interpolatedHeight = (float)((double)oldValue.height + (double)(newValue.height - oldValue.height) * interpolationValue);
        return new Rect(interpolatedX, interpolatedY, interpolatedWidth, interpolatedHeight);
    }

    public boolean contains(Rect parent) {
        return this.contains(parent.x, parent.y, parent.getWidth(), parent.getHeight());
    }
    ...
    public boolean inside(Rect parent) {
        return this.inside(parent.x, parent.y, parent.getWidth(), parent.getHeight());
    }
